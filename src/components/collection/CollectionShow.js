...
function CollectionShow(props) {
	...
	const {currentUser, handleChange, comments, commentPostId, comment, deleteComment, handleCommentSubmit} = props
  return (
    <>
